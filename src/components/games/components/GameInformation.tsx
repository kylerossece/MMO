    ...
    return (
        <div className="flex gap-4 items-center hover:scale-105  bg-gray-800 hover:rounded-sm shadow-2xl mt-0.5 ">
             ...
             <div className="my-2 tracking-tighter flex flex-col gap-1 text-xs">
                ...
                <h4 className="hover:underline cursor-pointer text-gray-200 text-sm " onClick={() => {handleGameClick(game.id)}}>{game.title}</h4>
                <p className=" bg-gray-700 inline-block px-1.5 py-0.5 rounded-md  text-gray-200 max-w-fit">{game.genre?.trim()}</p>
